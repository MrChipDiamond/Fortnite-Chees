...
#include "winrt/fnsln.h"
namespace winrt::fnsln::implementation
{
    template <typename D, typename... I>
    struct __declspec(empty_bases) exported_base : implements<D, fnsln::exported, composing, winrt::Windows::UI::Xaml::Controls::IPageOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides6, winrt::Windows::UI::Xaml::IFrameworkElementOverrides, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2, winrt::Windows::UI::Xaml::IUIElementOverrides, winrt::Windows::UI::Xaml::IUIElementOverrides7, winrt::Windows::UI::Xaml::IUIElementOverrides8, winrt::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = exported_base;
        using class_type = fnsln::exported;
        using implements_type = typename exported_base::implements_type;
        using implements_type::implements_type;
        using composable_base = winrt::Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"fnsln.exported";
        }
        exported_base()
        {
...
namespace winrt::fnsln::factory_implementation
{
    ...
    struct __declspec(empty_bases) exportedT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = fnsln::exported;
...
#if defined(WINRT_FORCE_INCLUDE_EXPORTED_XAML_G_H) || __has_include("exported.xaml.g.h")

#include "exported.xaml.g.h"
...
{
    template <typename D, typename... I>
    using exportedT = exported_base<D, I...>;
}
